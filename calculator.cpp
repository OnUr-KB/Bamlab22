...
LRESULT CALLBACK WndProc(HWND hwnd, UINT Message, WPARAM wParam, LPARAM lParam) {
	switch(Message) {
		...
		button = CreateWindow("BUTTON","+",WS_VISIBLE | WS_CHILD | WS_BORDER ,65,120,25,25,hwnd,(HMENU) 1,NULL,NULL );
		button = CreateWindow("BUTTON","-",WS_VISIBLE | WS_CHILD | WS_BORDER ,95,120,25,25,hwnd,(HMENU) 2,NULL,NULL );
		button = CreateWindow("BUTTON","*",WS_VISIBLE | WS_CHILD | WS_BORDER ,125,120,25,25,hwnd,(HMENU) 3,NULL,NULL );
		button = CreateWindow("BUTTON","/",WS_VISIBLE | WS_CHILD | WS_BORDER ,155,120,25,25,hwnd,(HMENU) 4,NULL,NULL );
		Textbox1 = CreateWindow("EDIT","",WS_VISIBLE | WS_CHILD | WS_BORDER ,45,50,160,25,hwnd,NULL,NULL,NULL );
		Textbox2 = CreateWindow("EDIT","",WS_VISIBLE | WS_CHILD | WS_BORDER ,45,80,160,25,hwnd,NULL,NULL,NULL );
		break;
